    ...
    <>
      <div className=' flex gap-8'>
        ...
        <div className='border-x w-[37.4rem]'>
          <ExploreNav />
          <section className='  bg-slate-100  mt-16'>
          ...
          <div className=''>
            <div className='flex justify-between items-center p-3 border-t'>
              <p className='font-bold text-xl flex gap-2'><svg viewBox='' className=' w-7 h-5 fill-sky-500'><path d="M12 1.75c-5.11 0-9.25 4.14-9.25 9.25 0 4.77 3.61 8.7 8.25 9.2v2.96l1.15-.17c1.88-.29 4.11-1.56 5.87-3.5 1.79-1.96 3.17-4.69 3.23-7.97.09-5.54-4.14-9.77-9.25-9.77zM13 14H9v-2h4v2zm2-4H9V8h6v2z"></path></svg> Business & finance
              </p>
              <i className='fa-solid fa-ellipsis rounded-full p-3 hover:bg-[#87cfeb3f] hover:text-sky-500'></i>
            </div>
        ...
        <section className='bg-slate-100 rounded-2xl mt-5 h-[19.8rem] w-[21rem] fixed right-32'>
